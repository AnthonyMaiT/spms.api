"""create_user_and_role_table

Revision ID: c7277cac56a8
Revises: 
Create Date: 2022-12-22 19:38:22.437536
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['role_type_id'], ['roleTypes.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id'),
